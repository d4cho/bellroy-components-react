            ...
            <div className='FeaturesSection_grid'>
                <div className='p-r-15'>
                    ...
                    <p>
                        ...
                        sorted, while external pockets give easy access to other
                        key items.
                    </p>
                </div>
                <img src={pocketOrganizationImg} alt={'pocket-organization'} />
                <img src={laptopProtectionImg} alt={'pocket-organization'} />
                <div className='p-l-15'>
                    <h2>LAPTOP PROTECTION</h2>
                    <p>
                        A protective sleeve holds your laptop snug when you're
                        on the move. No bouncing against your back.
                    </p>
                </div>
                <div className='p-r-15'>
                    <h2>STABILITY AND COMFORT</h2>
                    <p>
                        Lumbar support and contoured straps keep you carrying
                        comfortably all day long, even when fully packed.
                    </p>
                </div>
                <img src={stabilityAndComfortImg} alt={'pocket-organization'} />
                <img src={funFactImg} alt={'pocket-organization'} />
                <div className='p-l-15'>
                    <h2>FUN FACT</h2>
                    <p>
                        Ever think a backpack could be compared to a font? In{' '}
                        <span>this review</span>, Taylor Weldon said of the
                        Classic: "It's Helvetica in a bag; its success is in its
                        simplicity."
                    </p>
                </div>
                <div className='p-r-15'>
                    ...
                    <p>
                        "This daypack is for those who know what they want from
                        a bag. A traditional shape with unexpected engineering."
                    </p>
                </div>
