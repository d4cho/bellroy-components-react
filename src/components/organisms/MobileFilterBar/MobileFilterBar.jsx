      ...
      <div className='MobileFilterBar_container'>
            ...
            <Button
              content={
                <div className='MobileFilterBar_button'>
                  <LuSettings2 />
                  <span>{`Filters ${
                    chipList.length > 0 ? `(${chipList.length})` : ""
                  }`}</span>
                </div>
              }
        ...
        {chipList.length > 0 && (
          <div className='MobileFilterBar_chips_container'>
            {chipList.map((chip) => {
              return (
                <div className='MobileFilterBar_chips' key={chip.item}>
                  <Chips
                    content={chip.item}
                    onChipClick={() => handleRemoveFilterItem(chip)}
                  />
                </div>
              );
            })}
      ...
      <Modal
        ...
        modalHeader={
          <div className='Filter_Modal_Header_Container'>
            ...
            <div className='Filter_Modal_Header_Heading'>Filters</div>
            <GrClose
